...
<div class="main-header">
    <h1>📘 TRỢ LÝ SOẠN GIÁO ÁN TỰ ĐỘNG lớp 1 (NLS)</h1>
    <p>Tác giả: Dón Thị Minh - Trường PTDTBT Tiểu học Mậu Long - ĐT: 0398459222</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Dón Thị Minh - Trường PTDTBT Tiểu học Mậu Long - ĐT: 0398459222/div>", unsafe_allow_html=True)
